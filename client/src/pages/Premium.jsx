...
export default function Premium() {
  ...
  const generateReceipt = (purchaseInfo) => {
    ...
    doc.text('CodeArena Pro', 14, 16)
    doc.setFontSize(11)
    doc.setFont('helvetica', 'normal')
    doc.text('Subscription Receipt', 14, 26)
    ...
    doc.text('Thank you for subscribing! This receipt was auto-generated by CodeArena.', 14, y)
    doc.text('For support, contact: support@codearena.dev', 14, y + 8)

    doc.save(`CodeArena_Receipt_${Date.now()}.pdf`)
  }
